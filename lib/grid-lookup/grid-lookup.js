...
Grid.prototype = {
  ...
  wrappedIndices: function(c, r) {
    var col, row;
    col = c >= this.cols ? c - this.cols : c < 0 ? c + this.cols : c;
    row = r >= this.rows ? r - this.rows : c < 0 ? r + this.rows : r;
    return [col, row];
  },
  ...
  move: function(objId, x1, y1, x2, y2, w, h) {
    ...
    if (i21 <= i12 && i22 >= i11 && j21 <= j12 && j22 >= j11) {
      if (i11 === i21 && i12 === i22) {
        if (j11 === j21 && j12 === j22) {
          return null;
        }
        if (j21 > j11) {
          this.deleteCR(objId, i11, j11, i12, j21 - 1);
        } else if (j21 < j11) {
          this.insertCR(objId, i21, j21, i22, j11 - 1);
        }
        if (j22 > j12) {
          this.insertCR(objId, i21, j21 + 1, i22, j22);
        } else if (j22 < j12) {
          this.deleteCR(objId, i11, j22 + 1, i12, j21);
        }
        return null;
      }
      if (i21 > i11) {
        this.deleteCR(objId, i11, j11, i21 - 1, j12);
        if (j21 > j11) {
          this.deleteCR(objId, i21, j11, i12, j21 - 1);
        } else if (j21 < j11) {
          this.insertCR(objId, i21, j21, i22, j11 - 1);
        }
        if (j22 > j12) {
          ...
          this.deleteCR(objId, i21, j22 + 1, i12, j21);
        }
      } else if (i21 < i11) {
        this.insertCR(objId, i21, j21, i11 - 1, j22);
        if (j21 > j11) {
          this.deleteCR(objId, i11, j11, i12, j21 - 1);
        } else if (j21 < j11) {
          this.insertCR(objId, i21, j21, i22, j11 - 1);
      ...
      if (i22 > i12) {
        this.insertCR(objId, i12 + 1, j21, i22, j22);
        if (j21 > j11) {
          this.deleteCR(objId, i11, j11, i12, j21 - 1);
        } else if (j21 < j11) {
          this.insertCR(objId, i21, j21, i22, j11 - 1);
        ...
        this.deleteCR(objId, i22 + 1, j11, i12, j12);
        if (j21 > j11) {
          this.deleteCR(objId, i11, j11, i22, j21 - 1);
        } else if (j21 < j11) {
          this.insertCR(objId, i21, j21, i22, j11 - 1);
        }
        if (j22 > j12) {
          ...
          this.deleteCR(objId, i11, j22 + 1, i22, j21);
        }
      }
    } else {
